...
import com.sandbox.jasperpdfjava21.dao.TicketReportDao;
...
public class TicketReportDaoImpl implements TicketReportDao {

    private static final EntityManagerFactory emf = Persistence.createEntityManagerFactory("db2PU");

    @Override
    public List<TicketReport> findAll() {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createNamedQuery("TicketReport.findAll", TicketReport.class)
                    .getResultList();
        } finally {
            em.close();
        }
    ...
    public JasperPrint generateBankSummaryReport(InputStream reportTemplateStream, Map<String, Object> parameters)
        ...
        List<TicketReport> transactionList = findAll();
