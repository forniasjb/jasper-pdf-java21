...
public class TransactionBean implements Serializable {
    ...
    // LOGGER.info("Starting Bank Summary report generation process using JDBC
    // Connection...");
    ...
    // return null;
    // }
    // // Extract java.sql.Connection safely using Hibernate's Session
    // doReturningWork
    // // API
    ...
    public StreamedContent getFile() {
        LOGGER.info(
                "Starting Financial_Accounting_Department_Debit_Advice report generation process using JREmptyDataSource...");
        ...
        try {
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport(cachedJasperReport, new HashMap<>(), dataSource);
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
